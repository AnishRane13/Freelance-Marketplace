      ...
      <div className="p-5">
        ...
        <div className="space-y-2 mb-5">
          <div className="flex items-center text-sm">
            ...
            <span className="font-medium text-gray-900">{formatPrice(job.price)}</span>
          </div>
          ...
          <div className="flex items-center text-sm">
            ...
            <span className="text-gray-600">Deadline: {formatDate(job.deadline)}</span>
            <span className={`ml-2 text-xs font-medium ${isUrgent ? 'text-red-600' : 'text-green-600'}`}>
